...
public:
    ...
    int getCampHealth() { return campHealth; }  //基地生命
    int getPlayerHealth() { return playerHealth; }   //玩家生命
    int getWave() { return wave; }   //波次
    int getWood() { return wood; }   //木材数量
    int getStone() { return stone; }   //石材数量
    int getBronze() { return bronze; }  //铜锭数量
    int getSilver() { return silver; }  //银锭数量
    int getGold() { return gold; } //金锭数量
